...
Usage:
    py scripts/refresh_landing_log/refresh_landing_log.py --check   # CI gate; exits non-zero on drift
    py scripts/refresh_landing_log/refresh_landing_log.py --write   # apply rewrite in place

Configuration in `scripts/refresh_landing_log/landing-log-config.json` lists which plan files
