...
Usage:
    ...
    python scripts/check-diagnostic-codes/check-diagnostic-codes.py --self-test
    python scripts/check-diagnostic-codes/check-diagnostic-codes.py --list-uncovered
