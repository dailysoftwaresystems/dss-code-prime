...
|-------|---------------------------------------------------------------------|----------------|
| G-001 | **Parser unborn.** `src/analysis/syntactic/` is a `.gitkeep` stub.   | Without it the tokenizer produces tokens nothing consumes. The single biggest "does this work" risk. See [`05-parser-plan - tbd.md`](./05-parser-plan - tbd.md). |
