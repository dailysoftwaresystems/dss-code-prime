...
> 2. **HIR → MIR → LIR.** Three IR layers, not one. ([`09-hir-plan`](./09-hir-plan%20-%20ok.md), [`12-mir-lir-plan`](./12-mir-lir-plan%20-%20tbd.md))
...
|---|---|---|
| HIR + MIR + LIR (replaces single-SSA G-301) | §3 G-301a/b/c, G-309, G-310 | [`09-hir-plan`](./09-hir-plan%20-%20ok.md), [`12-mir-lir-plan`](./12-mir-lir-plan%20-%20tbd.md) |
