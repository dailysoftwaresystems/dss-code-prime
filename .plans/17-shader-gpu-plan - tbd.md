...
| Predecessors  | ⏳ [`09-hir-plan`](./09-hir-plan%20-%20tbd.md) (shader-shape HIR extensions). ⏳ [`12-mir-lir-plan`](./12-mir-lir-plan%20-%20tbd.md) (structured-CF markers carry into SPIR-V `OpLoopMerge` / `OpSelectionMerge`). |
