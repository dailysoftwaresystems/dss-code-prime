...
| | |
|---|---|
| Status        | 🟡 **In flight.** PR0 ✅ shipped. PR1 ✅ shipped + review-fixed. PR2a ✅ shipped + review-fixed. PR2b ✅ shipped + review-fixed. PR3 ✅ shipped + review-fixed. PR4 ✅ shipped + review-fixed. PR5 ✅ shipped + review-fixed (`lexerModes` + `LexerModeStack` with fatal-on-empty discipline; Snapshot has owner-stack tag; `lexerModes()` hides sentinel; keywords reject modeOp; near-miss case-folded duplicate-mode warning; inline-tokens deferral surfaces warning; `lookupLexemeInMode` aborts on invalid id). 452 ctest cases across 24 suites, 100% pass. PR6 (stringStyle) next. |
