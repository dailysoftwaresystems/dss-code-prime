...
| Predecessors  | 🟡 [`09-hir-plan`](./09-hir-plan%20-%20tbd.md) (the pivot layer — HR1–HR7 ✅ (HR1–HR5 2026-05-26, HR6–HR7 2026-05-27), incl. the `TranspileHint` / `HirTranspileMap` side-table this plan consumes — round-trip-serialized by HR7's `.dsshir` format; HR8–HR11 pending). ⏳ [`08.5-substrate-prep-plan`](./08.5-substrate-prep-plan%20-%20tbd.md) (core type lattice). |
