...
| Predecessors  | 🟡 [`09-hir-plan`](./09-hir-plan%20-%20tbd.md) (the pivot layer — HR1–HR9 ✅ (HR1–HR5 2026-05-26, HR6–HR9 2026-05-27), incl. the `TranspileHint` / `HirTranspileMap` side-table this plan consumes — round-trip-serialized by HR7's `.dsshir` format; HR8 added the config-driven CST→HIR lowering engine (c-subset), HR9 enriched toy into a typed language + un-deferred arrays end-to-end; HR10–HR11 pending). ⏳ [`08.5-substrate-prep-plan`](./08.5-substrate-prep-plan%20-%20tbd.md) (core type lattice). |
