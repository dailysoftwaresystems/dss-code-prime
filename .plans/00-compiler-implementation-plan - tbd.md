...
| **IR** — HIR + MIR + LIR (rev 2; replaces single-IR plan) | 🟡 in progress — HIR HR1–HR4 ✅ (2026-05-26, `feature/hir-1`). Production-readiness §3 (G-301a/b/c + G-302..G-310). Owned by [`09-hir-plan`](./09-hir-plan%20-%20tbd.md) (HIR — the pivot; HR1–HR4 done, HR5–HR11 pending) + [`12-mir-lir-plan`](./12-mir-lir-plan%20-%20tbd.md) (MIR SSA-over-CFG with structured-CF markers + LIR per-target ISA; ⏳ planned). |
...
| 8 | [09](./09-hir-plan%20-%20tbd.md) HR1–HR11 | HIR — language-neutral structured typed pivot; CST→HIR lowering per shipped language | step 7 | 🟡 HR1–HR4 ✅ (2026-05-26, `feature/hir-1`); HR5–HR11 pending |
