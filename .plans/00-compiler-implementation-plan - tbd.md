...
| **V2-3** | artifactProfile AP2–AP4 (~3) | Driver/project-config enforcement + codegen-reads-profile + CLI diag rendering (AP1 schema field already closed — §0.2 D4). Registered-set vocab (cli/gui/lib/staticlib/script/sproc/transpile/shader/hdl). Gates steps 13+16. | [06](./06-artifact-profile-plan%20-%20tbd.md) | — | ⏳ |
