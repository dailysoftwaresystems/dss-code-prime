...
| 13.7 cycle 9+ | [`22`](./22-optimizer-plan%20-%20tbd.md) OPT7+ | Tier-neutral `scalar_eval` consolidation → cost/machine/peephole/pipeline as JSON → OPT10 autotuner. Also: general block-merge (Phi-fan-out + StructCfMarker re-derivation — D-OPT4-1). | step 13.7 cycle 8 ✅ | ⏳ planned |
