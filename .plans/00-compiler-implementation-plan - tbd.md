...
| **7** | [08.6](./08.6-semantic-plan%20-%20tbd.md) SE1–SE7 | Symbol table + scope resolution + type checking — **config-driven** (`semantics` block, schema v4; one language-agnostic engine). SE1 toy engine+config → SE2 c-subset config → SE3 tsql config → SE4–SE7 | step 6 ✅ | 🟢 **SE1 in progress** |
