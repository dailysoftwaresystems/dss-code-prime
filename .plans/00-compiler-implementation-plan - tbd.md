...
| 13.7 cycle 8 | [`22`](./22-optimizer-plan%20-%20tbd.md) OPT6 LICM | Loop-invariant code motion: hoist invariants out of loops via dom-tree + natural-loop detection (back-edge identification). Triggers `D-OPT-RESULT-CHANGED-FIELD` (mutate-without-counter), activates `loop_invariant` corpus arm. | step 13.7 cycle 7 ✅ | ⏳ planned |
