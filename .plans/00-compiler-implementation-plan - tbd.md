...
| 13.7 cycle 11+ | [`22`](./22-optimizer-plan%20-%20tbd.md) OPT7+ inlining | Tier-neutral `scalar_eval` consolidation → cost/machine/peephole/pipeline as JSON → OPT10 autotuner. Remaining LICM enhancements (D-OPT6-LICM-PREHEADER-INSERTION + D-OPT6-LICM-TRAP-SAFE-HOIST blocked on D-CSUBSET-DIVISION-OP-CODEGEN); D-OPT-COPYPROP-BLOCK-CURSOR; D-OPT4-1-NON-LINEAR-MARKER-MERGE (WASM/SPIR-V trigger). | step 13.7 cycle 10h-10o ✅ | ⏳ planned (OPT7 = hard-stop boundary per autonomous-loop guardrails — supervised cycle) |
