...
| **V2-4** | program-api CLI (~2–3) | `dss-code-prime build my-project.dss-project.json`: project loader + driver + clang-quality diagnostic renderer. Makes the compiler a usable tool. | §8 program-api (step 16) | V2-3 (artifactProfile) | ⏳ |
