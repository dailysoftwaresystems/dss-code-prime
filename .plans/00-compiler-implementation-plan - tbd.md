...
| 13.7 cycle 10r | [`14`](./14-linker-plan%20-%20tbd.md) Arc A capstone — c-subset division corpus | Plan: `examples/c-subset/division/main.c` (`int q = a/b; int r = a%b;`) + `expected.json` with two-armed correctness (baseline vs full release). Closes D-CSUBSET-DIVISION-OP-CODEGEN. Unblocks D-OPT6-LICM-TRAP-SAFE-HOIST. | step 13.7 cycle 10q | ⏳ planned |
