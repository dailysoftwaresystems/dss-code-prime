...
| 13.7 cycle 3+ | [`22`](./22-optimizer-plan%20-%20tbd.md) OPT4+ | copy-prop + dominator-tree + liveness → LICM → CSE/GVN → tier-neutral `scalar_eval` consolidation → cost/machine/peephole/pipeline as JSON → OPT10 autotuner. | step 13.7 cycle 2 ✅ | ⏳ planned |
