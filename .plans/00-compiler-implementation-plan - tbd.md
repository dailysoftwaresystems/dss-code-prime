...
| **V3-3** | Mach-O exec-verify | macOS CI runner → execution-verify the Mach-O target already emitted (the macho exit block 13X.2). Completes 3-OS execution verification. (orig 13X.2) | 13X.2 | macOS runner | ⏳ trigger-gated (runner) |
