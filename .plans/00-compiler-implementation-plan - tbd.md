...
| 7.5 | ⏳ **new** — sub-plan [`08-compilation-unit-plan - tbd.md`](./08-compilation-unit-plan - tbd.md) | `compilation-unit-model` | Multi-file translation units + import resolution | analysis-syntactic | Bridges parser (per-file `Tree`) and semantic (cross-file symbol table). Five PRs (CU1–CU5; CU5 multi-language CUs added rev 2). Closes G-110 + G-111. **v1:** CU1–CU4. **v1.1:** CU5. |
