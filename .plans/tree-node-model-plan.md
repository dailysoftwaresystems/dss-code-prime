...
| Test suite | **458 cases across 24 ctest suites — 100% pass** (v1 T0–T12 baseline + v2 PR0–PR5 additions; see [`schema-expressiveness-v2-plan.md`](./schema-expressiveness-v2-plan.md) §0 for per-PR test counts) |
