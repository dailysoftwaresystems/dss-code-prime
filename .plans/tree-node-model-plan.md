...
| Test suite | **378 cases across 22 ctest suites — 100% pass** (v1 T0–T12 baseline + v2 PR0–PR3 additions; see [`schema-expressiveness-v2-plan.md`](./schema-expressiveness-v2-plan.md) §0 for per-PR test counts) |
