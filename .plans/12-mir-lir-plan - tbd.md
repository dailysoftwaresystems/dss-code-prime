...
| Predecessors  | ⏳ [`08.5-substrate-prep-plan`](./08.5-substrate-prep-plan%20-%20tbd.md) (arena reuse). 🟡 [`09-hir-plan`](./09-hir-plan%20-%20tbd.md) (input — HR1–HR7 ✅ 2026-05-26..27, HR8–HR11 pending; HR7's `.dsshir` text format is the sibling-discipline reference for ML4's `.dssir` / ML8's `.dsslir` round-trip). |
