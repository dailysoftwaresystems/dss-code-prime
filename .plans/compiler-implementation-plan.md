...
| Core types — tree/node/diagnostics/schema + schema-aware `TreeBuilder` + `TreeCursor` + `tree_visitor` + `NodeAttribute<T>` (sub-plan T0–T8, 9 of 12 phases) | ✅ landed — **232 ctest cases, 100% pass** |
| Core types — views + end-to-end (sub-plan T9–T10, T12) | ⏳ next |
