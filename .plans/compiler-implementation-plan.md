...
| Core types — tree/node/diagnostics/schema + schema-aware `TreeBuilder` + `TreeCursor` + `tree_visitor` + `NodeAttribute<T>` + typed views (sub-plan T0–T9, 10 of 12 phases) | ✅ landed — **268 ctest cases, 100% pass** |
| Core types — end-to-end + docs (sub-plan T10, T12) | ⏳ next |
