...
| Core types — tree/node/diagnostics/schema + schema-aware `TreeBuilder` (sub-plan T0–T5, 6 of 12 phases) | ✅ landed — **136 ctest cases, 100% pass** |
| Core types — cursor + visitor + attrs + views + end-to-end (sub-plan T6–T10, T12) | ⏳ next |
