...
| Core types — tree/node/diagnostics/schema + schema-aware `TreeBuilder` + `TreeCursor` + `tree_visitor` (sub-plan T0–T7, 8 of 12 phases) | ✅ landed — **179 ctest cases, 100% pass** |
| Core types — attrs + views + end-to-end (sub-plan T8–T10, T12) | ⏳ next |
