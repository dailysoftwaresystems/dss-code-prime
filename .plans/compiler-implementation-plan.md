...
| Core types — tree/node/diagnostics/schema + schema-aware `TreeBuilder` + `TreeCursor` + `tree_visitor` + `NodeAttribute<T>` + typed views + E2E (sub-plan T0–T10, 11 of 12 phases) | ✅ landed — **277 ctest cases, 100% pass** |
| Core types — docs (sub-plan T12) | ⏳ next |
