...
// (2026-06-01) from three prior duplicates:
//   * tests/ffi/test_binary_reader.cpp
//   * tests/ffi/test_c_header_parser.cpp
//   * tests/ffi/test_abi_catalog.cpp
//
// Matches the `scratch_dir.hpp` hoist precedent: third consumer
// trips the threshold; the helper is structurally identical
// across consumers (pure read over the reporter's span).
