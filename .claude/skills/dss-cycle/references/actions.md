...
- The generated action index — regenerated by `dssharness run check-scripts-index --manual-step write`, never hand-edited
...
```bash
dssharness run check-scripts-index --manual-step write
```
