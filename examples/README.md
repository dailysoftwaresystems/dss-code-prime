...
- `targets[]` — see below. *596 — every manifest, which is the only value this row can legitimately have: both runners reject a manifest without one.*
- `$comment` — the repo-wide config-documentation convention: provenance, what the example witnesses, the red-on-disable argument. Ignored by the runners. *473.*
