 ...
 * a c source can actually REACH, each as a BYTE-EXACT pin: a wrong offset /
 ...
 * UNREACHABLE from c, so they are pinned synthetically at the asm tier:
 ...
 * Aggregate-global encoder shapes reachable from c (all const-init → `.rodata`):
