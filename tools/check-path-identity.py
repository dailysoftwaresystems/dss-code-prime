...
Usage:
    python tools/check-path-identity.py            # check
    python tools/check-path-identity.py --selftest # prove the matcher detects
    python tools/check-path-identity.py --regen    # reprint the allowlist
"""
    ...
    for p in sorted(SRC.rglob("*")):
        ...
        if INCLUDE_FS.search(code) and r not in ALLOWLIST:
            problems.append(
                ...
                f"in tools/check-path-identity.py.\n"
