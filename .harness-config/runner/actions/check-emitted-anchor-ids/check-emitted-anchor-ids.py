...
INVENTORY = {
    ...
    "src/hir/hir_verifier.cpp": 7,
    "src/hir/lowering/cst_to_hir.cpp": 14,
    ...
    "src/lir/lowering/mir_to_lir.cpp": 50,
    "src/mir/lowering/hir_to_mir.cpp": 81,
