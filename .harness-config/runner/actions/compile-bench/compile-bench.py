...
--------------------------------------------------------------------
`.harness-config/runner/actions/profile-compile/` answers the OTHER half of the same question, and its
...
def load_build_type_reader(repo):
    path = os.path.join(repo, ".harness-config", "runner", "actions", "profile-compile",
                        "profile-compile-support.py")
    if not os.path.isfile(path):
        die(".harness-config/runner/actions/profile-compile/profile-compile-support.py is missing under %s. "
